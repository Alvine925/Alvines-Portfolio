...
Understanding the difference, and knowing what your options are for different scratch types, saves money and prevents making damage worse through inappropriate treatment. This guide covers scratch assessment and treatment for Kenyan vehicle owners.

![Car paint scratch close-up showing damage](https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=1200&q=80)

## Understanding Automotive Paint Structure

To understand scratches, you need to understand what you're scratching.

Modern vehicle paint (on vehicles manufactured since the 1980s) has a multi-layer structure:

**Primer:** The first layer applied to bare metal. Provides adhesion for subsequent layers and corrosion protection.
...
**Type 3: Deep scratches to primer**

These penetrate through both clear coat and base coat to reach the primer layer. They're typically white or grey in colour (primer colour) and may show texture from the substrate underneath.

**Can polishing fix these?** No. Professional paint touch-up (using a matched touch-up pen or a body shop respray) is required.
...
## DIY Scratch Treatment: What You Can and Can't Do

**For Type 1 (clear coat only) scratches:**

Light scratches can be improved at home with scratch removal products:

Products like Meguiar's ScratchX, Turtle Wax scratch removers, or AutoGlym Super Resin Polish contain fine abrasives that can remove or reduce shallow clear coat scratches when applied with a clean microfiber cloth.
...
DIY treatment is not recommended. The options are:
- Touch-up pen (for small scratches): fills the scratch with matched colour paint. Reduces visibility in the short term but doesn't achieve a professional finish.
- Professional machine polish (for Type 2 border cases): may improve appearance around the scratch
- Body shop respray (for Type 3 and 4): the only correct treatment

**What to avoid:**

Wax or polish applied to a deep scratch that needs touching up. This improves the surrounding paint's appearance, making the untreated scratch more visually obvious by contrast.

Sandpaper on paint without professional guidance. Many DIY "scratch removal" approaches involving wet sanding cause significantly more damage than the original scratch.

Household products on scratches. Toothpaste, nail polish remover, and similar home remedies are occasionally recommended online; they're not appropriate for automotive paint and can cause additional damage.

## Professional Scratch Removal Services from AutoShine

AutoShine provides professional scratch assessment and treatment for Kenyan vehicles.

**Step 1: Scratch assessment**

Our technicians assess each scratch under directional light to determine:
- Scratch depth (clear coat only, through to base coat, or deeper)
...
For Type 1 scratches confirmed to be in the clear coat, our machine polishing service can remove or significantly reduce visibility:

- Isolated scratch polishing: treating specific scratch areas without a full panel polish
...
After polishing, the corrected area (and ideally the full vehicle) is protected with wax, sealant, or ceramic coating to prevent rapid re-scratching.

## Scratch Prevention for Kenyan Drivers
