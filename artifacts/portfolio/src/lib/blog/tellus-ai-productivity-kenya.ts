...
AI is compressing the productivity gap between well-resourced and less-resourced operations in ways that matter specifically for Kenya's business landscape, where resource constraints are real and where the cost of every tool must justify itself quickly.

Tellus is built on this conviction: that AI applied to the right problems produces compounding returns for Kenyan professionals. This article explores where those returns are largest and how Kenyan businesses are capturing them.

![AI productivity tools on computer screen](https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=1200&q=80)

## The Kenyan Productivity Challenge
...
Tellus is designed around a specific insight: that productivity AI is only valuable if people actually use it, and people only use tools that fit within their existing workflows rather than requiring them to adopt entirely new patterns.
...
![Professional using AI tools on multiple screens](https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1200&q=80)
...
- Domain expertise (AI generalises; professionals with deep domain knowledge direct AI toward correct answers)
- Interpersonal and relationship skills (AI handles information; humans handle trust and relationship)
- Creative direction and vision (AI executes; humans decide what to create and why)
- Ethical judgment (AI follows patterns; humans ensure those patterns serve legitimate ends)

**What becomes less valuable:**
- Routine information processing (AI does this better and faster)
...
Claiming that AI improves productivity is easy. Measuring it requires discipline.
...
**Cost per unit of output:** For business processes, cost per output unit (cost per resolved customer inquiry, cost per article, cost per approved loan application) captures the combined effect of speed and quality on business economics.

## Getting Started with AI Productivity Tools in Kenya

The AI tools available to Kenyan professionals include both global tools (Claude, ChatGPT, Gemini, GitHub Copilot, Notion AI) and locally-built tools optimised for Kenya's specific context (Tellus).
