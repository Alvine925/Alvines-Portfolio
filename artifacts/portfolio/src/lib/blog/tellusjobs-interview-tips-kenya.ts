...
## Understanding the Kenyan Interview Landscape
...
**The case interview:** Used by consulting firms, strategy teams in large corporates, and some NGOs for analytical roles. You're given a business problem and expected to work through it aloud in real time.

**The group exercise or assessment centre:** Some large Kenyan employers (banks, telcos, some NGOs) use group assessments where candidates work together on a task while being observed. The evaluators are assessing collaboration, communication, and leadership behaviour in group contexts.

## The Foundation: Deep Company Research

The difference between generic answers and standout answers is almost always specificity, and specificity requires research. Candidates who walk into Kenyan interviews without company research produce answers that could apply to any employer. Candidates who have done deep research produce answers that feel tailored and genuine.
...
The most common format in Kenyan panel interviews is competency-based questioning: "Tell me about a time when..." or "Give me an example of..." These questions are designed to understand your past behaviour as a predictor of future performance.
...
![Interview preparation practice session](https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=1200&q=80)

## The Questions Kenyan Interviewers Always Ask
...
**"Why are you leaving your current role?"** Focus on what you're moving toward, not what you're escaping. Even if you're leaving because of a terrible manager, the interview answer should be about the opportunity ahead of you rather than the problems behind.

**"Do you have any questions for us?"** Always have questions. Good questions include: What does success look like in this role in the first six months? What are the biggest challenges facing the team right now? What do you enjoy most about working here? What's the culture around professional development? Bad questions: anything answered on their website, anything about salary before you have an offer, anything that makes the role sound conditional.
...
**Data analysis:** Be fluent in SQL with demonstrated ability to write complex queries. Know your way around Excel at an advanced level. For roles requiring Python or R, review data manipulation, visualisation, and statistical analysis fundamentals.
...
**Post-interview follow-up:** Send a brief thank-you email to your contact at the company within 24 hours of the interview. This is standard practice internationally and increasingly appreciated in Kenyan professional contexts. It also gives you an opportunity to add any point you felt you didn't make as strongly as you wanted to.

## Common Interview Mistakes That Cost Kenyan Candidates Offers

**Over-answering:** Answering a different, broader question than the one actually asked. Listen carefully and answer specifically.
...
**Not asking questions:** Candidates who have no questions at the end of an interview signal either lack of preparation or lack of genuine interest.

**Underselling on results:** Kenyan professional culture tends toward modesty that works against candidates in interview contexts. Quantify your results. Specific achievements beat vague impressions every time.

![Confident professional after successful job interview](https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=1200&q=80)
