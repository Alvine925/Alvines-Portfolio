...
![Car wash business setup with equipment and team](https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1200&q=80)
...
**The corporate gap:** Kenyan corporations with vehicle fleets represent large, consistent, high-value contracts that most informal car washes are unable to service reliably. Professional fleet washing businesses with invoicing capability, consistent scheduling, and corporate-appropriate presentation have a large underserved market.
...
**Mobile car wash:**
Equipment and staff transported to customers. Lower capital requirement (no facility lease), broader geographic reach, and ability to serve corporate fleet accounts at their premises.

Best for: Operators with access to a vehicle, initial capital for equipment and supplies, and a strategy for building a customer base in their target area.

**Detailing studio:**
Premium service, longer service times, higher prices. Focuses on the professional detailing segment (correction, ceramic coating, interior deep clean) rather than basic washing. Requires significant skill investment and appropriate space.

Best for: Operators with professional detailing skills or the ability to hire them, targeting the premium vehicle segment.

**Hybrid (fixed location + mobile):**
A fixed-location base combined with mobile service capability. The fixed location builds brand presence and handles walk-in customers; mobile service handles corporate accounts and customers who can't visit the location.

Best for: Businesses scaling beyond initial startup stage.

## Startup Costs for a Kenyan Car Wash Business
...
Location is the most important single decision for a fixed-location car wash business.
...
The car wash supply market in Kenya has both professional-quality products and cheap imitations. Using the wrong products creates customer complaints and, more importantly, damages vehicles.
...
- Honesty (working around customers' vehicles and possessions)
- Positive customer manner

**Training:**

Train all staff in:
- The two-bucket method (essential for preventing paint scratching)
- Product selection for each surface type
- Sequence of washing (top to bottom, wheels last before rinse)
- Drying technique (straight lines, clean microfiber only)
- Interior cleaning to your service standard
...
If your business offers demonstrably better quality (professional products, trained staff, proper technique), price at the top of the competitive range or above. Customers who value quality will pay for it; you do not need to compete on price with informal operators.

**Service menu:**

A clear, simple service menu posted at your facility removes negotiation and sets clear expectations:
- Basic Wash: KES 350 (saloon) / KES 450 (SUV)
- Standard Wash + Vacuum: KES 600 / KES 750
- Full Interior + Exterior: KES 900 / KES 1,100
...
Build a customer contact list from day one. Every customer who leaves satisfied should be invited to join your WhatsApp business contact list for updates and promotions. Monthly promotions communicated via WhatsApp to your list are a cost-effective way to drive repeat business.
...
Happy customers who refer friends are your most effective marketing channel. A formal referral programme (refer a friend, both get a discount on their next wash) activates this word-of-mouth intentionally.
...
AutoShine's platform includes an operator programme that allows independent car wash businesses to list on the AutoShine platform, receive customer bookings through the app, manage their schedule, and process payments through AutoShine's M-Pesa integration.

Benefits of listing on AutoShine:
- Customer discovery through the AutoShine platform
- Online booking capability (without building your own booking system)
